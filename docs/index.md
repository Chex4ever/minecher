...
| [version-sources.md](version-sources.md) | Источники версий и скачивание jar |
| [testing.md](testing.md) | Как тестировать, проверенные сценарии, ограничения |

Для быстрого старта пользователя — `README.md` в корне репозитория. Для ИИ-агентов — `AGENTS.md`.
